...
const SamsungTvPairing = require('./SamsungTvPairing')
const SamsungTvConnection = require('./SamsungTvConnection')
...
class SamsungTv {
  ...
  onConnected(listener) {
    this.eventEmitter.on(SamsungEvents.CONNECTED, listener)
  }
